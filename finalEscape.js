...
var door = new RoomObject('Door','you need the key',[],['key'],'use key')
var drawer = new RoomObject('Drawer','slids drawer open',['key'],[],'use drawer')
var coatRack = new RoomObject('Coat', 'put your jacket here', ['jacket'], [], 'use coat')
var closet = new RoomObject('Closet','you need a jacket',['flashlight','blanket'],['jacket'],'use flashlight')


var RoomObjectsArray = []
RoomObjectsArray.push(door,drawer,closet, coatRack)
...
RoomObject.prototype.interact = function (action) {
    ...
    } else if (this.needsItems()) { // Description should describe items you need/what to do at room
...
Room.prototype.getObject = function (objectName) {
    ...
    return object // Only checks if the object is actually in room 
}
